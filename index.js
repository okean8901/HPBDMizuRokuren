const contentLetterSrart_actived = "CHÚC MỪNG SINH NHẬT BÉ MIZU NHAAAA." //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc mừng sinh nhật em, mong rằng sang tuổi mới em sẽ luôn hạnh phúc và vui vẻ bên người mình yêu thương, chúc em có thể trở thành ma pháp thiếu nữ để cùng anh chống chọi thế giới tàn nhẫn này và cảm ơn em vì đã làm bạn với anh nhé, Mãi iuuuu <3" //Nội dung của bức thư
